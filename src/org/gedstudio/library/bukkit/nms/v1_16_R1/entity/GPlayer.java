package org.gedstudio.library.bukkit.nms.v1_16_R1.entity;
...
public class GPlayer implements org.gedstudio.library.bukkit.entity.GPlayer {
    ...
    public void setSkin(Skin skin) {
        ...
        final PacketPlayOutRespawn respawn = new PacketPlayOutRespawn(entityPlayer.getWorld().getTypeKey(), entityPlayer.getWorldServer().getDimensionKey(), entityPlayer.getWorldServer().getSeed(), entityPlayer.playerInteractManager.getGameMode(), entityPlayer.playerInteractManager.getGameMode(), entityPlayer.getWorldServer().isDebugWorld(), entityPlayer.getWorldServer().isFlatWorld(), true);
        for (org.gedstudio.library.bukkit.entity.GPlayer player : GedLibrary.getInstance().getOnlinePlayers()) {
