...
public class GScoreBoard implements org.gedstudio.library.bukkit.scoreboard.GScoreBoard, Serializable {
    ...
    public GScoreBoard(String title, String... context) {
        ...
        this.objective = scoreboard.registerObjective("gedlib_sb", IScoreboardCriteria.b, new ChatComponentText(title), IScoreboardCriteria.EnumScoreboardHealthDisplay.INTEGER);
