package org.gedstudio.library.bukkit.nms.v1_13_R1.inventory;
        ...
        if (nbtTagCompound.getKeys().size() != 0) {
            for (String key : nbtTagCompound.getKeys()) {
                if (nbtTagCompound.get(key) instanceof NBTTagString) {
                    this.maps.put(key, ((NBTTagString) nbtTagCompound.get(key)).b_());
                } else if (nbtTagCompound.get(key) instanceof NBTTagInt) {
                    this.maps.put(key, ((NBTTagInt) nbtTagCompound.get(key)).e());
                    ...
                    this.maps.put(key, ((NBTTagFloat) nbtTagCompound.get(key)).i());
                } else if (nbtTagCompound.get(key) instanceof NBTTagShort) {
                    this.maps.put(key, ((NBTTagShort) nbtTagCompound.get(key)).f());
                } else if (nbtTagCompound.get(key) instanceof NBTTagLong) {
                    this.maps.put(key, ((NBTTagLong) nbtTagCompound.get(key)).d());
                } else if (nbtTagCompound.get(key) instanceof NBTTagByte){
                    this.maps.put(key, ((NBTTagByte) nbtTagCompound.get(key)).g());
                } else if (nbtTagCompound.get(key) instanceof NBTTagIntArray){
                    this.maps.put(key, ((NBTTagIntArray) nbtTagCompound.get(key)).d());
                } else if (nbtTagCompound.get(key) instanceof NBTTagByteArray){
                    this.maps.put(key, ((NBTTagByteArray) nbtTagCompound.get(key)).c());
                } else if (nbtTagCompound.get(key) instanceof NBTTagLongArray) {
                    this.maps.put(key, ((NBTTagLongArray) nbtTagCompound.get(key)).d());
                }
            }
        }
    }
